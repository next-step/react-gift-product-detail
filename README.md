...
## 3 단계 - 테마 상품 목록 페이지 구현하기

- [x] 선물하기 홈 > 선물 테마 섹션의 아이템을 클릭하면 테마 상품 목록 페이지로 연결
- [x] `/api/themes/:themeId/info` API 를 사용 히어로 섹션 정보 받아오기
- [x] 선물 테마 섹션의 히어로 영역 UI 구현
- [x] 테마 정보를 가져오는 API 에서 404 에러 발생 시, `/home` 으로 이동
- [x] `/api/themes/:themeId/products` API 를 사용하여 상품 리스트 정보 받아오기
- [x] 테마 페이지의 상품 리스트 UI 구현
- [x] 무한 스크롤 구현
...
- [x] 제품 상세 페이지
  ...
  - [x] ErrorBoundary 라이브러리 없이 리펙토링

## 3단계 - 테스트 코드 **작성하기**

- [ ] `src/components/` 의 Form Field 와 Typography 에 대한 테스트코드 작성
- [ ] 로그인 페이지에 대한 시나리오 작성 후 테스트 코드 작성
- [ ] MSW 를 사용하여 실시간 급상승 선물랭킹 섹션의 테스트 코드 작성
