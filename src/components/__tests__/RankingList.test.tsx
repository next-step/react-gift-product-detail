...
describe('RankingList', () => {
  ...
  it('정상적으로 상품 목록을 표시하고 더보기 버튼을 동작시킨다', async () => {
    ...
    expect(screen.getAllByText('1,000')[0]).toHaveTextContent('1,000 원')
    ...
    expect(screen.getByText('Brand 7')).toBeInTheDocument()
    expect(screen.getByAltText('Product 7')).toHaveAttribute('src', 'image7.jpg')
    ...
    expect(screen.queryByText('Brand 7')).not.toBeInTheDocument()
