...
export const LoginForm = () => {
    ...
    return (_jsx(LoginFormSection, { email: email, password: password, onChangeEmail: e => setEmail(e.target.value), onChangePassword: e => setPassword(e.target.value), onSubmit: handleSubmit, emailError: emailError, passwordError: passwordError, loginError: loginError, isFormValid: isFormValid }));
};
