export const queryKeys = {
  ...
  products: {
    ...
    wish: (id: number) =>
      [...queryKeys.products.details(), id, "wish"] as const,
    review: (id: number) => [...queryKeys.products.all, id, "review"] as const,
    info: (id: number) => [...queryKeys.products.all, id, "info"] as const,
  },
};
